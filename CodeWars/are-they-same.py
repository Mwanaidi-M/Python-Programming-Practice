def comp_array(arr1, arr2):
    ...
    a member is the number of times it appears). "Same" means, here, that the elements in b
    ...
    if arr1 is None or arr2 is None:
        return False
    elif sorted([val ** 2 for val in arr1]) == sorted(arr2):
        return True
    else:
        return False


print(comp_array([121, 144, 19, 161, 19, 144, 19, 11], [121, 14641, 20736, 361, 25921, 361, 20736, 361]))
print(comp_array([121, 144, 19, 161, 19, 144, 19, 11], [132, 14641, 20736, 361, 25921, 361, 20736, 361]))
